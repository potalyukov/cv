## Nikita Potaliukov - CV Full version [[Download PDF]](https://drive.google.com/file/d/11Z1J8xMx2LQv-4Z1h1RmzCTpPvxw5cfD/view?usp=sharing)
...
Software developer with 13 years of experience, including Android (5+ years), Unity/C# (5+ years), C#/.NET (2 years) and full-cycle product development — from idea to scaling. Worked with both startups and global companies like Tecan (Swiss medtech)
...
**Android:**  
Android SDK, Kotlin, Java, Jetpack Compose, Compose Multiplatform, Kotlin Multiplatform, Kotlin Coroutines, Flow, Clean Architecture, Dagger, Hilt, Koin, Gradle, Modularization, MVVM, MVI, MVU, AAC, Room, SQLite, PostgreSQL, Firebase (databases, authorization, analytics), Retrofit, okHttp, FMOD, AAudio, ExoPlayer, OpenCV, JNI, AIDL, IAPs (Google Play, AppGallery), AdMod, Ironsource, Appodeal
...
*Dec 2025 - present*
- Created the whole app architecture for a Kotlin Multiplatform project
- Connected Low-Level C++ code to the KMP project.

**Technologies:** Kotlin Multiplatform, Compose Multiplatform, Koin, Coroutines, Flow, Clean Architecture, Gradle, Modularization, MVVM, SQLite, SQLDelight, FMOD, JNI

---

### Professional Development Sabbatical
*Dec 2024 - Dec 2025 · 1 yr*
- Studied the Yandex Practicum course, gaining practical experience in modern Android development.
- Created my own DI library for Unity projects.

**Technologies:** Kotlin, Android, Gradle, Modularization, MVVM, MVI, MVU, AAC, Room, SQLite, PostgreSQL, Firebase, Retrofit, okHttp, FMOD, AAudio, ExoPlayer, OpenCV, JNI
...
- Optimized legacy code, resulting in 15% faster application startup time.
...
- Successfully shipped 15+ products from scratch to Google Play and AppGallery, taking them through all stages (design, development, launch) – top title Dj Loop Pads has reached 30M+ installs.
- Conducted 12 workshops on C# and algorithms
...
- Increased Dj Loop Pads' average rating from 4.35 to 4.78 by reworking UX alongside designers and analysts.
- Implemented a high-load backend handling 400K requests per hour, ensuring stability and scalability.
- Optimized Firebase Firestore data structure and queries, reducing costs by 20%.
- Trained the art department in Git version control, reducing content integration costs by 30-40%.

**Technologies:** Android, Java, Firebase (databases, authorization, analytics, push notifications), JNI/C/C++, FMOD, Unity/C#, IAPs (Google Play, AppGallery)
...
**Technologies:** Android, Java, PostgreSQL, Spring, Hibernate, OpenCV, C++
...
- Improved an existing piano keyboard (complex multitouch handling) that improved UX

**Projects:**
- Music Synthesizer – Sound wave generation, synthesis, modulation, effects. Low-level audio buffer manipulation.
...
**Technologies:** Android, Java, Low-level Audio, JNI, C
...
- Latest public Android code written by me [GitHub](https://github.com/potalyukov/tree-database-app)
